DECLARE @BackupFilePath NVARCHAR(128) = N'C:\WorkingFolders\FWD\AutoRodent\backups\AutoBackup.bak'
DECLARE @LogicalDataFileName NVARCHAR(128) = N'AdventureWorks2016_Data'
DECLARE @LogicalLogFileName NVARCHAR(128) = N'AdventureWorks2016_Log'
